 ...
 */
exports.NoAuthSecuritySchemeSchema = z.object({
    type: z.literal('noauth')
});
/**
 * Security scheme indicating OAuth 2.0 authentication is required.
 */
exports.OAuth2SecuritySchemeSchema = z.object({
 ...
 */
exports.SecuritySchemeSchema = z.union([exports.NoAuthSecuritySchemeSchema, exports.OAuth2SecuritySchemeSchema]);
/**
...
exports.ToolSchema = z.object({
     ...
     */
    securitySchemes: z.array(exports.SecuritySchemeSchema).optional(),
    /**
     * See [MCP specification](https://github.com/modelcontextprotocol/modelcontextprotocol/blob/47339c03c143bb4ec01a26e721a1b8fe66634ebe/docs/specification/draft/basic/index.mdx#general-fields)
     * for notes on _meta usage.
     */
