...
export class McpServer {
    ...
    setToolRequestHandlers() {
        ...
        this.server.setRequestHandler(ListToolsRequestSchema, () => {
            ...
            console.log('Tool list handler called');
            return {
    ...
    _createRegisteredTool(name, title, description, inputSchema, outputSchema, annotations, securitySchemes, _meta, callback) {
        ...
        const registeredTool = {
            ...
            update: updates => {
                ...
                if (typeof updates.securitySchemes !== 'undefined')
                    registeredTool.securitySchemes = updates.securitySchemes;
    ...
    registerTool(name, config, cb) {
        ...
        return this._createRegisteredTool(name, title, description, inputSchema, outputSchema, annotations, securitySchemes, _meta, cb);
    }
    prompt(name, ...rest) {
